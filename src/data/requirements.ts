...
export const requirements: Requirement[] = [
  // ELIGIBILITY
  {
    ...
    detail: 'You were a member of Beachsiders (club #621469), but your membership has lapsed. Beachsiders still meets every Friday, noon to 1 PM, in person at Youth Guidance in Vero Beach (checked Sep 25, 2026). Online clubs count too. You must stay a member through Level 2 in August 2028.',
    evidence: 'Active membership in Base Camp / club roster',
    action: 'Rejoin Beachsiders as your home club and add 1 online club for extra speaking slots.',
    deadline: '2026-10-15', source: 'https://www.toastmasters.org/Find-a-Club/00621469-beachsiders-club', defaultStatus: 'not_started',
  },
  {
    ...
    detail: 'You earned Advanced Communicator Bronze (ACB), one of the three awards that qualify. That means you do NOT have to finish a Pathways path. Once you rejoin, make sure ACB shows on your education record.',
    evidence: 'ACB on your Toastmasters education transcript',
    action: 'After rejoining, check your transcript for ACB. If it is missing, contact Member Services with the year you earned it.',
    deadline: '2026-10-31', source: HANDBOOK, defaultStatus: 'done',
  },
  {
  ...
  // ENGAGEMENTS
  {
    ...
    detail: 'For a Jan 2028 application, count talks from about Feb 2025 on. Aim for 30 so you can drop the weak ones. You have 2 free outside talks so far. Each counts only if it had 20+ people, ran 20+ minutes, and happened after about Feb 2025.',
    evidence: 'Engagement log: Date · Organization · Contact/Client · Length · Fee · Audience size',
    action: 'Log your 2 earlier talks now (date, organization, contact, length, audience). Then log every new talk the same day.',

...
export type Month = {
  ...
  milestone: string;
  targets: { engagements: number; paid: number; fee: number };
...
export const roadmap: Month[] = [
  {
    ...
    targets: { engagements: 1, paid: 0, fee: 0 },
    weeks: [
      'Rejoin: Beachsiders (Fridays at noon, Vero Beach) as your home club, plus 1 online club. Check that your ACB shows on your education transcript.',
      'Speaking inventory: list every talk, story, workshop, and area of expertise you already have, including the 2 outside talks you gave and the 150+ club visits. Write the Missing Piece opening.',
    ...
    toastmasters: ['First speech back: the Missing Piece opening', 'Take 2 meeting roles', 'Table Topics at every meeting'],
  ...
  },
  {
    ...
    targets: { engagements: 2, paid: 0, fee: 0 },
    weeks: [
    ...
    toastmasters: ['Same speech at 3 clubs, using your club-visiting network', 'Evaluate 2 speakers'],
  ...
  },
  {
    ...
    targets: { engagements: 3, paid: 0, fee: 0 },
    weeks: [
    ...
    toastmasters: ['Evaluate at an Advanced club to sharpen your judging eye', 'Test the Money opening', 'Humor experiment: 1 planned laugh per 2 minutes'],
  ...
  },
  {
    ...
    targets: { engagements: 5, paid: 1, fee: 0 },
    weeks: [
      'Jan 2027 is off the table (you need 15 paid talks first). Stay on the Jan 2028 plan and log your 2 earlier outside talks with full details.',
    ...
    toastmasters: ['Give the SIRS talk to a Toastmasters audience first (clarity test for non-experts)', 'Table Topics: practice answering board-member questions on SIRS'],
  ...
  },
  {
    ...
    targets: { engagements: 8, paid: 2, fee: 1 },
    weeks: [
    ...
    toastmasters: ['Give the Missing Piece 20-min version at an Advanced club', 'Practice Q&A handling'],
  ...
  },
  {
    ...
    targets: { engagements: 11, paid: 4, fee: 2 },
    weeks: [
  ...
  },
  {
    ...
    targets: { engagements: 14, paid: 6, fee: 3 },
    weeks: [
    ...
    toastmasters: ['Record a club talk and score it with the Level 1 ballot', 'Facilitate a club workshop'],
  ...
  },
  {
    ...
    targets: { engagements: 16, paid: 8, fee: 5 },
    weeks: [
    ...
    toastmasters: ['Test the keynote opening at 2 clubs', 'Test the workshop exercises on a club audience'],
  ...
  },
  {
    ...
    targets: { engagements: 18, paid: 10, fee: 6 },
    weeks: [
    ...
    toastmasters: ['Rehearse the full video talk at 2 clubs before filming', 'Ask an AS mentor to watch one club run-through'],
  ...
  },
  {
    ...
    targets: { engagements: 21, paid: 11, fee: 7 },
    weeks: [
      ...
      'Pitch an education session to your Toastmasters District conference (free talk that leads to paid referrals).',
    ],
    toastmasters: ['Test the new opening and closing'],
  ...
  },
  {
    ...
    targets: { engagements: 23, paid: 13, fee: 8 },
    weeks: [
      'Build the 15–18 min Level 2 version of your best talk. The introduction must state your expertise.',
      'Watch the 2027 convention AS Level 2 coverage. Note what passing talks do.',
      '2 paid talks.',
      'Fourth recommendation form.',
    ],
    toastmasters: ['Give the 15–18 min version at 2 Advanced clubs', 'Ask evaluators to score it with the Level 2 ballot'],
  ...
  },
  {
    ...
    targets: { engagements: 25, paid: 15, fee: 8 },
    weeks: [
      ...
      'Plan Oct–Dec: grow to 30 engagements and draft the application.',
    ],
    toastmasters: ['Run the Level 2-style talk at a new club every week', 'Give the Level 2-style 15–18 min talk at an Advanced club'],

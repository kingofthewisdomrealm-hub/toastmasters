...
- Speaker one-sheet v1
- Contact 10 organizations
- Set up the engagement log habit
- Ask 3 AS mentors
...
2. v2 → Club B. Test a new story in the middle section.
3. v3 → Club C (an Advanced club). Ask for tough feedback.
...
**Outside Toastmasters**
- Book the first community talk (Sebastian River Chamber or Rotary Club of Sebastian)
- Contact 10 more organizations
...
2. Money: What’s Missing? outline and 5-minute test.
3. Watch the recording. Score yourself against the Level 1 ballot.
...
**Outside Toastmasters**
- First 20-minute outside talk
- First practice recording
- Ask the host for the head count and a written thank-you
...
**Outside Toastmasters**
- Fee sheet
- First paid booking (even a small fee counts, if agreed in advance)
- 2 more community talks
...
2. Kiwanis or Lions talk. Collect a testimonial on camera (phone is fine).
3. Paid association workshop (SIRS).
...
**Outside Toastmasters**
- 3 outside talks
- First recommendation-form candidate identified (paying client)
...
2. Pitch HOAs, realtor associations, and senior communities for paid pre-season workshops.
3. Deliver 2 hurricane talks.
4. Ask the paying clients to send recommendation forms right away.

**Inside Toastmasters**
- Test demonstrations and props at a club
- Evaluate at an Advanced club

**Outside Toastmasters**
- 3 outside talks (2 paid)
- First recommendation form sent in
...
2. Deliver the workshop (Chamber, SCORE, or Builders Association).
3. 2 more talks. Record one with a single camera and a lapel mic.
...
2. Pitch 5 regional conferences and associations (Orlando, Palm Beach).
3. 2 paid talks.
...
2. Write your professional introduction. It must state your expertise.
3. Record video #1 (20–60 min, no edits).
4. Send it to your mentor to score against the Level 1 ballot.
...
**Outside Toastmasters**
- Video #2
- All 5 recommendations confirmed
